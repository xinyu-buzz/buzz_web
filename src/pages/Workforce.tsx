...
export default function Workforce() {
  ...
  const screenshots = [
    ...
    { name: 'notam', alt: 'NOTAMs' },
    { name: 'charts', alt: 'Aviation Charts' },
    { name: 'metar', alt: 'METAR' },
    { name: 'profile', alt: 'Pilot Profile' },
    { name: 'promotion', alt: 'Promotion' },
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Every pilot is licensed, verified, insured, and ready. You get pros, not problems.',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
